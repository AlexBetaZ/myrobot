...
bool handle_drive_request(ball_chaser::DriveToTarget::Request& req, ball_chaser::DriveToTarget::Response& res)
{
    ...
    res.msg_feedback = "Linear velocity in x-axis set - j1: " + std::to_string(req.linear_x) + ", Angular velocity around z-axis set - j2: " + std::to_string(req.angular_z);
...
int main(int argc, char** argv)
{
    ...
    ROS_INFO("Read to send velocity commands");
